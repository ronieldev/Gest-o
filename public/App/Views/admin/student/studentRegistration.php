                ...
                <form class="mt-3" id="addStudent" role="form" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row collapse" id="student-registration-address-and-others" data-parent="#student-record-accordion">
                        <div class="col-lg-10 col-11 mx-auto">
                            ...
                            <h6 class="font-weight-bold">Responsável financeiro</h6>

                            <div class="form-row">

                                <div class="form-group col-md-5">
                                    <label for="responsibleName">Nome do responsável:</label>
                                    <input type="text" id="responsibleName" value="" class="form-control" name="responsibleName" required>
                                </div>

                                <div class="form-group col-md-3">
                                    <label for="responsibleCpf">CPF do responsável:</label>
                                    <input type="text" id="responsibleCpf" value="" class="form-control" name="responsibleCpf" maxlength="14" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="responsiblePhone">Telefone do responsável:</label>
                                    <input type="tel" id="responsiblePhone" value="" class="form-control" name="responsiblePhone" placeholder="(00) 00000-0000" required>
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="responsibleEmail">E-mail do responsável:</label>
                                    <input type="email" id="responsibleEmail" value="" class="form-control" name="responsibleEmail" required>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div containerRegistrationSuccess class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-lg-12 p-0 font-weight-bold"><i class="fas text-info fa-info-circle mr-2"></i> O código de acesso é gerado automaticamente e enviado para o e-mail informado, para que o estudante possa acessar o portal do aluno pela primeira vez. Em seguida, é recomendado que essa senha seja alterada!</p>
