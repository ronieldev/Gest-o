...
if (count($this->view->listCurriculumGrid) >= 1) {
    ...
    <tr class="mt-4">
        <td class="font-weight-bold" colspan="4" style="pointer-events:none"><?= count($this->view->listCurriculumGrid) ?> aulas listadas <i class="fas fa-history ml-2"></i></td>
    </tr>

<?php } else { ?>

    <tr class="mt-4">
        <td colspan="4" style="pointer-events:none">Nenhuma aula adicionada na grade curricular <i class="fas fa-history ml-2"></i></td>
    </tr>
