...
class AdminController extends Action
{
    ...
    public function auth()
    {
        ...
        $accessCode = $Tool->formatElement($_POST['accessCode']);

        if (empty($accessCode) || (int) $accessCode === 0) {
        ...
        $Admin->__set('accessCode', $accessCode);
    ...
    public function updateAdminProfilePicture()
    {
        ...
        empty($_GET['oldPhoto']) ? '' : unlink('assets/img/adminProfilePhotos/' . $_POST['oldPhoto']);

        $Tool->image($Admin, 'assets/img/adminProfilePhotos/');
    ...
    public function adminInsert()
    {
        ...
        (new Mailer())->sendAccessCode($_POST['email'], $_POST['name'], $accessCode, 'https://' . $_SERVER['HTTP_HOST'] . '/admin/login');
