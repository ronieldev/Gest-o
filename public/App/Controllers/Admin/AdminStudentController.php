...
class AdminStudentController extends Action
{
    ...
    public function studentInsert()
    {
        ...
        $ResponsibleAddress = Container::getModel('People\\Address');
        $ResponsibleTelephone = Container::getModel('People\\Telephone');
        $ResponsibleFinancial = Container::getModel('GeneralManagement\\ResponsavelFinanceiro');

        $ResponsibleAddress->__set('district', $_POST['district']);
        $ResponsibleAddress->__set('address', $_POST['address']);
        $ResponsibleAddress->__set('uf', $_POST['uf']);
        $ResponsibleAddress->__set('county', $_POST['county']);
        $ResponsibleAddress->__set('zipCode', $Tool->formatElement($_POST['zipCode']));

        $ResponsibleTelephone->__set('telephoneNumber', $Tool->formatElement($_POST['responsiblePhone']));

        $ResponsibleFinancial->__set('responsibleName', $_POST['responsibleName']);
        $ResponsibleFinancial->__set('cpf', $Tool->formatElement($_POST['responsibleCpf']));
        $ResponsibleFinancial->__set('email', $_POST['responsibleEmail']);
        $ResponsibleFinancial->__set('fk_id_telephone', $ResponsibleTelephone->insert());
        $ResponsibleFinancial->__set('fk_id_address', $ResponsibleAddress->insert());

        $accessCode = $Tool->generateAccessCode();
        $Student->__set('accessCode', $accessCode);

        $Student->__set('name', $_POST['name']);
        $Student->__set('birthDate', $_POST['birthDate']);
        $Student->__set('cpf', $Tool->formatElement($_POST['cpf']));
        $Tool->image($Student, 'assets/img/studentProfilePhotos/');
        $Student->__set('naturalness', $_POST['naturalness']);
        $Student->__set('nationality', $_POST['nationality']);
        $Student->__set('motherName', $_POST['motherName']);
        $Student->__set('fatherName', $_POST['fatherName']);
        ...
        $Student->__set('fk_id_responsible', $ResponsibleFinancial->insert());
        ...
        (new Mailer())->sendAccessCode($_POST['email'], $_POST['name'], $accessCode, 'https://' . $_SERVER['HTTP_HOST'] . '/portal-aluno/login');
    ...
    public function updateStudentProfilePicture()
    {
        ...
        empty($_GET['oldPhoto']) ? '' : unlink('assets/img/studentProfilePhotos/' . $_POST['oldPhoto']);
