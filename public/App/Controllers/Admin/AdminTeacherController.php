...
class AdminTeacherController extends Action
{
    ...
    public function teacherInsert()
    {
        ...
        $Teacher->__set('accessCode', $accessCode);
        $Teacher->__set('cpf', $Tool->formatElement($_POST['cpf']));
        $Tool->image($Teacher, 'assets/img/teacherProfilePhotos/');
        ...
        (new Mailer())->sendAccessCode($_POST['email'], $_POST['name'], $accessCode, 'https://' . $_SERVER['HTTP_HOST'] . '/portal-docente/login');
    ...
    public function updateTeacherProfilePicture()
    {
        ...
        empty($_GET['oldPhoto']) ? '' : unlink('assets/img/teacherProfilePhotos/' . $_POST['oldPhoto']);
