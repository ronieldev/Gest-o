...
class Course extends Model
{
    ...
    public function insert()
    {
        ...
        $query = "INSERT INTO curso(nome_curso, sigla , fk_id_modalidade_curso) VALUES (:courseName, :acronym, (SELECT id_modalidade_curso FROM modalidade_curso ORDER BY id_modalidade_curso LIMIT 1))";
