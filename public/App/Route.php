...
class Route extends Bootstrap
{
	...
	protected function initRoutes()
	{
		...
		// Rotas referente ao financeiro no portal do administrador

		$routes['adminFinanceManagement'] = array(
			'route' => '/admin/financeiro',
			'controller' => 'Admin\\AdminFinanceController',
			'action' => 'financeManagement'
		);

		$routes['adminFinanceInsert'] = array(
			'route' => '/admin/financeiro/inserir',
			'controller' => 'Admin\\AdminFinanceController',
			'action' => 'financeInsert'
		);

		$routes['adminFinanceList'] = array(
			'route' => '/admin/financeiro/lista',
			'controller' => 'Admin\\AdminFinanceController',
			'action' => 'financeList'
		);

		$routes['adminFinanceData'] = array(
			'route' => '/admin/financeiro/dados',
			'controller' => 'Admin\\AdminFinanceController',
			'action' => 'financeData'
		);

		$routes['adminFinanceMarkAsPaid'] = array(
			'route' => '/admin/financeiro/marcar-pago',
			'controller' => 'Admin\\AdminFinanceController',
			'action' => 'financeMarkAsPaid'
		);

		$routes['adminFinanceAvailableStudents'] = array(
			'route' => '/admin/financeiro/lista-alunos',
			'controller' => 'Admin\\AdminFinanceController',
			'action' => 'availableStudents'
		);
		...
		// Rotas do diário eletrônico no portal do docente

		$routes['teacherDiaryManagement'] = array(
			'route' => '/portal-docente/diario',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryManagement'
		);

		$routes['teacherDiaryInsert'] = array(
			'route' => '/portal-docente/diario/inserir',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryInsert'
		);

		$routes['teacherDiaryList'] = array(
			'route' => '/portal-docente/diario/lista',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryList'
		);

		$routes['teacherDiaryContentSuggestion'] = array(
			'route' => '/portal-docente/diario/conteudo-sugerido',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryContentSuggestion'
		);

		$routes['teacherDiaryData'] = array(
			'route' => '/portal-docente/diario/dados',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryData'
		);

		$routes['teacherDiaryUpdate'] = array(
			'route' => '/portal-docente/diario/atualizar',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryUpdate'
		);

		$routes['teacherDiaryDelete'] = array(
			'route' => '/portal-docente/diario/deletar',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryDelete'
		);

		$routes['teacherDiaryAttachmentInsert'] = array(
			'route' => '/portal-docente/diario/anexo/inserir',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryAttachmentInsert'
		);

		$routes['teacherDiaryAttachmentDelete'] = array(
			'route' => '/portal-docente/diario/anexo/deletar',
			'controller' => 'TeacherPortal\\TeacherDiaryController',
			'action' => 'diaryAttachmentDelete'
		);
