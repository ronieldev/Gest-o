...
class CurriculumGrid extends Model
{
    ...
    public function insert()
    {
        ...
        $query = "INSERT INTO disciplina (nome_disciplina, sigla_disciplina, fk_id_modalidade_disciplina) VALUES (:disciplineName, :acronym, :fk_id_modality)";
    ...
    /**
     * Retorna as modalidades disponíveis, usado para preencher a tag select na View
     *
     * @return array
     */
    ...
    public function update()
    {
        ...
        $query = "UPDATE disciplina SET nome_disciplina = :disciplineName, sigla_disciplina = :acronym, fk_id_modalidade_disciplina = :fk_id_modality WHERE disciplina.id_disciplina = :disciplineId";
    ...
    /**
     * Busca grades curriculares por nome da disciplina e/ou modalidade
     *
     * @return array
     */
